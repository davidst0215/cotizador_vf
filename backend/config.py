...
class FactoresTDV:
    ...
    FACTORES_ESTILO = {
        'Muy Recurrente': {'descripcion': 'Más de 4,000 prendas fabricadas', 'factor': 0.95},
        'Recurrente': {'descripcion': 'Menos de 4,000 prendas fabricadas', 'factor': 1.00},
    ...
    @classmethod
    def validar_rango_seguridad(cls, valor: float, componente: str) -> tuple[float, bool]:
